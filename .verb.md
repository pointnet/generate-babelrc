# {%= name %} {%= badge('npm') %} {%= badge('downloads') %}

{%= description %}

{%= badge('travis') %} [![Build status](https://ci.appveyor.com/api/projects/status/github/{%= repository %}?svg=true)](https://ci.appveyor.com/project/pointnet/generate-babelrc) {%= badge('coveralls') %}
