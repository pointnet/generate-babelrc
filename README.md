...
Use `generate-babelrc` as a [plugin][docs]{plugins.md} in your own [generator][docs]{generators.md}.
...
The following instructions can be used to override settings in `generate-babelrc`. Visit the [Generate documentation][docs]{overriding-defaults.md} to learn about other ways to override defaults.
